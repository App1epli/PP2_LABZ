...
#bg image
background = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy,size):
        super().__init__()
        if size == "small":
            self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/small_coin.png")
        elif size == "medium":
            self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/med_coin.png")
        elif size == "large":
            self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/big_coin.png")
        self.rect = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_9/img/getcoin.mp3").play()
