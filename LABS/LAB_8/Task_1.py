...
#bg image
background = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_8/img/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_8/img/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_8/img/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_8/img/coin.png")
        self.rect = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_8/sound/crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound("C:/Users/Admin/Documents/PP_2_labs/LABS/LAB_8/sound/getcoin.mp3").play()
        coin_score += 1
        coin = Coin(E1)
        coins_group.add(coin)
